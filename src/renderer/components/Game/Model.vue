	...
	export default {
		data(){
			return{
				...
				gameList:[],
				user:null,
				allReg:["{去尾}","{压尾}","{输翻1}","{止100000}","{10倍}","{上1期-号码一}","{上1期-号码二}","{上1期-号码三}","{上1期-号码}","{上1期-组合}","{上1期-单双}","{上1期-大小}","{上1期-中边}","{中}","{边}","{大}","{小}","{单}","{双}","{追0-100期}","{切换模式-模式名称}","{输后}","{赢后}","{输加200}","{历史20期}","{开0}","{选号-1|2|3|4|5|6}","{100期停}"],
				modelSelect:{},
				tmpAllModel:null
			}
		},
